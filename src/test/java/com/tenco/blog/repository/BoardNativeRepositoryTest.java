...
//   }
    ...
    public void findAll_test(){
        // given - 테스트를 위한 준비 단계
        // 게시글 목록 조회 정상 작동하는지 확인 -->data.sql 파일에 데이터 이미 준비
        ...
        //Assertions.assertThat(boardList.size()).isEqualTo(4); //Assertions 단언
        Assertions.assertThat(boardList.get(3).getUsername()).isEqualTo("ssar"); //Assertions 단언
